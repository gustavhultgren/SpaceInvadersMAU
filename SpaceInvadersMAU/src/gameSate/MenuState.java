...
/**
 * B�ttre och f�rkortad version av MainPanel
 * 
...
public class MenuState extends GameState implements MouseListener, KeyListener, MouseMotionListener {
	...
	public MenuState() throws MalformedURLException {
		...
		// instansierar och l�gger till bakgrunden som en gif
		...
		/*
		 * L�gger till leaderboard-knappen
		 */
		...
		/*
		 * L�gger till en bakgrund som en gif
		 */
	...
	/**
	 * Metod som lyssnar ifall man klickar p� musen
	 * 
	...
	/**
	 * Metod som lyssnar ifall man klickar p� en mus
	 * 
	...
	/**
	 * Metod som lyssnar ifall man sl�pper ett musklick
	 * 
	 * @param e MouseEvent objekt
	 */
	...
	/**
	 * Metod som lyssnar ifall musen r�r sig in i ett objekt
	 * 
	 * @param e MouseEvent objekt
	 */
	...
	/**
	 * Metod som lyssnar ifall musen l�mnar ett objekt
	 * 
	 * @param e ett MouseEvent objekt
	 */
	...
	/**
	 * Metod som lyssnar ifall man skriver in n�got med tangentbordet
	 * 
	 * @param e
	 */
	...
	/**
	 * Metod som k�rs ifall man klickar p� en tangent p� tangentbordet
	 */
	...
	public void keyPressed(KeyEvent e) {
		...
		// Om man tittar p� piltangenten - Ner
		...
		// Om man klickar p� piltangenten - Upp

		if (key == KeyEvent.VK_UP) {

			setCursor(blankCursor); // d�ljer muspekaren och g�r s� att man inte kan anv�nda den
			cursorWorking = false;
		...
		// Om man klickar p� Space-tangenten
		...
		// Om man klickarp p� Enter-tangenten
		...
		// Om man klickar p� Shift-tangenten
	...
	/**
	 * H�mtar den nuvarande operationen som motsvarar markeringen i menyn
	 * 
...
//				mainMenuLabels[i].setText(mainMenuLabels[i].getText().substring(1, mainMenuLabels[i].getText().length()-2));
	...
	/**
	 * Metod som lyssnar ifall man drar musen samtidigt som man h�ller ner en knapp
	 * 
	 * @param e MouseEvent objekt
	 */
	...
	public void mouseMoved(MouseEvent e) {
		...
		// S�tter muspekaren tillbaka till default-muspekaren
