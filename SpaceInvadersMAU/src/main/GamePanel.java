...
public class GamePanel extends JPanel implements Runnable, KeyListener {
	...
	public static LinkedList<EnemyBomb> bombs; //ToDo: Ta bort denna listan och för varje enemy längst ut: rita bomb.
	...
	public void run() {
		...
		while(running) {
			...
			if(frameCount == maxFrameCount) {
				averageFPS = 1000.0 / (((double)totalTime / frameCount
						) / 1000000);
				frameCount = 0;
				totalTime = 0;
			}
